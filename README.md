...
|---|---------|----------|-------|------|
| 01 | IPL Squad & Salary Tracker | Can a CLI tool manage live auction budgets and squad composition cleanly? | Python, functions, CLI | [`IPL-squad-tracker`](./01.IPL-squad-tracker) |
